...
Matrix operator*(const Matrix& a, const Matrix& b) {
	...
	for (int r = 0; r < 4; r++) {
		for (int c = 0; c < 4; c++) {
			result.Components[r][c] = 
				a.Components[r][0] * b.Components[0][c] + 
				a.Components[r][1] * b.Components[1][c] + 
				a.Components[r][2] * b.Components[2][c] + 
				a.Components[r][3] * b.Components[3][c];
		}
	}
